      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur rounded-full border border-canvas-200 shadow-sm mb-8">
            ...
            <span className="text-sm font-medium text-canvas-700">Free for artists</span>
          </div>

          {/* Headline */}
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-canvas-900 mb-6 leading-loose">
            A Gallery of
          ...
          <p className="text-lg sm:text-xl text-canvas-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            A dead-simple online gallery for emerging visual artists. Create your portfolio, organize collections, share with the world. Gallery formats optimized for comics and manga creators are available.
          </p>
