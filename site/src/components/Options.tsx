import { Cloud, GraduationCap, Check, ArrowRight } from 'lucide-react';
...
const options = [
  {
    icon: Cloud,
    title: 'VFA.Gallery',
    subtitle: 'The public gallery',
    description: 'Sign up, create your portfolio, and share your work with the world. Free, ad-supported, no setup required.',
    features: [
      'Instant account creation',
      'Unlimited galleries & collections',
      'Mobile-first design',
      'Shareable URLs for every artwork',
  ...
  },
  {
    icon: GraduationCap,
    title: 'For Schools',
    subtitle: 'Self-hosted on Google Workspace',
    description: 'Run your own private gallery using tools your school already has. Perfect for art classes and student portfolios.',
    features: [
