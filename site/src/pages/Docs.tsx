...
import { setupDocs, operationsDocs, troubleshootingDoc, type DocSection } from '../data/docs';
...
export function Docs() {
  ...
  const [activeSection, setActiveSection] = useState<string>(setupDocs[0].id);
  ...
  // When tab changes, reset to first section of that tab
  const handleTabChange = (tabId: TabId) => {
    setActiveTab(tabId);
    const docs = tabId === 'setup' ? setupDocs : tabId === 'operations' ? operationsDocs : [troubleshootingDoc];
      ...
      <div className="bg-white border-b border-canvas-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-canvas-600">
            Step-by-step guides to set up and manage your school art gallery.
          </p>
        </div>
      </div>
